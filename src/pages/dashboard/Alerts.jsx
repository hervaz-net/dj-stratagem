...
const seedAlerts = [
  { id: 1, type: "risk", title: "GlobalParts risk score exceeded 65", detail: "Score rose from 52 → 68 over 7 days. Consider sourcing alternatives for critical SKUs.", supplier: "GlobalParts Ltd.", time: "14 min ago", read: false },
  { id: 2, type: "delivery", title: "IronLine on-time delivery dropped below 90%", detail: "3 of the last 4 orders arrived late. Current 30-day rate: 87.5%.", supplier: "Ironline Distribution", time: "1 hr ago", read: false },
  { id: 3, type: "bid", title: "Bid #2040 under review — deadline in 48 hrs", detail: "Summit Ridge Apartments bid closes Aug 2. No response from GC yet.", supplier: null, time: "2 hr ago", read: false },
  { id: 4, type: "price", title: "Structural steel index up 6.4% this week", detail: "Market movement may affect PO-1187 final pricing. Review before approval.", supplier: "Ironline Distribution", time: "4 hr ago", read: true },
  { id: 5, type: "risk", title: "Apex Materials fill rate below SLA", detail: "Fill rate fell to 82% this month against a 90% SLA threshold.", supplier: "Apex Materials", time: "Yesterday", read: true },
  { id: 6, type: "delivery", title: "PO-1185 shipment delayed 2 days", detail: "Summit Fasteners reported carrier delay. New ETA: Aug 1.", supplier: "Summit Fasteners", time: "Yesterday", read: true },
  { id: 7, type: "system", title: "Supplier data refresh completed", detail: "All 124 supplier risk scores and delivery rates updated from last night's feed.", supplier: null, time: "Yesterday", read: true },
  { id: 8, type: "bid", title: "Bid #2041 awarded — Apex Electrical", detail: "Riverside Medical Office awarded. Contract value: $412k.", supplier: null, time: "2 days ago", read: true },
        ...
        <div className="space-y-3">
          {displayed.map((a) => {
            ...
            return (
              <GlassCard
                key={a.id}
                className={`border px-5 py-4 transition-opacity ${a.read ? "opacity-70" : ""} ${t.bg}`}
              >
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          <span className="rounded-full border border-line bg-ink px-2 py-0.5 text-xs font-semibold text-steel">
                            {t.label}
                          </span>
                          {!a.read && (
                      ...
                      <div className="flex shrink-0 flex-col items-end gap-2">
                        ...
                        <div className="flex gap-3">
                          ...
                          <button
                            ...
                            className="text-xs text-steel transition-colors hover:text-danger"
