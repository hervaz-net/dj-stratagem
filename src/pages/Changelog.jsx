...
const entries = [
  ...
  },
  {
    ...
    tag: "Fix",
    items: [
      { type: "fix", text: "Re-audit 19 Sep 2026 13:05 PDT: marketing routes render. Live bundle is still assets/index-BjqCrvkQ.js (public_html last-modified 19 Sep 10:26 UTC). /contact.php GET is 405 JSON. /api/me.php, /api/health.php, /health.php, /send-demo.php, and /manifest.webmanifest SPA-fallback to index.html. Live robots.txt is still the 72-byte allow-all file. /help and /docs do not 301. www does not 301 to apex. Contact chrome still shows hello@djstratagem.com because the live JS predates the inc.com source fix." },
